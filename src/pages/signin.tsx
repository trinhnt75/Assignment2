...
const Signin = () => {
  ...
  return (
    <div className="grid grid-cols-2   mt-10 items-center  mx-auto  w-[50%] bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700">
      <div className="px-10 space-y-2 ">
        ...
        >
          ...
          <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
            <button className="inline-block  shrink-0 rounded-md border border-[#FF4D4F] bg-[#FF4D4F] w-full py-3 text-sm  text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500">
              Đăng nhập
            </button>
          </div>
        </form>
      ...
      <div className=" px-10 py-[50%] h-[70vh] text-center">
        <img src="/images/logo.jpg" alt="" className="inline-block w-[400px]" />
      </div>
    </div>
  );
};
